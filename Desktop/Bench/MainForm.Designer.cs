namespace LabEquipmentController
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.rdoNetwork = new LabEquipmentController.SegmentButton();
            this.rdoSerial = new LabEquipmentController.SegmentButton();
            ...
            this.grpScan.Controls.Add(this.rdoNetwork);
            this.grpScan.Controls.Add(this.rdoSerial);
            ...
            this.grpScan.Controls.Add(this.lblScope);
            this.grpScan.Controls.Add(this.cboScope);
            this.grpScan.Controls.Add(this.lblBaud);
            this.grpScan.Controls.Add(this.cboBaud);
            ...
            // The heading is drawn rather than set: it *is* the switch, and a GroupBox cannot
            // hold a control inside its own Text. Empty here, and PositionScanHeading puts
            // [Network Scan | Serial Scan] over the top border where the heading would be.
            this.grpScan.Text = "";
            //
            // lblInterface
            //
            ...
            this.grpDevices.Controls.Add(this.cboSerialPort);
            ...
            //
            // rdoNetwork / rdoSerial
            //
            // The heading "Network Scan", made a control — and the other heading it could
            // have been beside it. Each half is a whole caption rather than a word with a
            // shared "Scan" after it: the two read as the two things this card can be, and
            // the selected half is the card's title outright.
            //
            // It picks which bench this card is looking at, and everything below follows it:
            // the inputs on this card, the columns of the list, and which box the Address row
            // shows. Network is the default and stays the default — it is what nearly every
            // instrument here is, and a bench with no serial adapter should never have to
            // notice this pair exists.
            //
            // Drawn as one segmented switch by StyleScanKind, and positioned over the group's
            // top border by PositionScanHeading. Still RadioButtons underneath: that is what
            // makes them mutually exclusive, walkable with the arrow keys, and one named
            // group to a screen reader.
            //
            this.rdoNetwork.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left)));
            // Sized by StyleScanKind from the caption, not by the control: AutoSize would put a
            // radio glyph's worth of padding back into a button that draws no glyph.
            this.rdoNetwork.AutoSize = false;
            this.rdoNetwork.Checked = true;
            this.rdoNetwork.Location = new System.Drawing.Point(10, 0);
            this.rdoNetwork.Name = "rdoNetwork";
            this.rdoNetwork.TabIndex = 0;
            this.rdoNetwork.TabStop = true;
            this.rdoNetwork.Text = "Network Scan";
            this.rdoNetwork.UseVisualStyleBackColor = true;
            //
            this.rdoSerial.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left)));
            this.rdoSerial.AutoSize = false;
            this.rdoSerial.Location = new System.Drawing.Point(80, 0);
            this.rdoSerial.Name = "rdoSerial";
            this.rdoSerial.TabIndex = 1;
            this.rdoSerial.Text = "Serial Scan";
            this.rdoSerial.UseVisualStyleBackColor = true;
            //
            //
            // lblScope / cboScope
            //
            // The serial answer to "Interface:" — which ports the sweep covers, and how many
            // there are. All of them by default; one, when somebody wants to ask a single
            // port without opening the others.
            //
            this.lblScope.AutoSize = true;
            this.lblScope.Location = new System.Drawing.Point(12, 28);
            this.lblScope.Name = "lblScope";
            this.lblScope.TabIndex = 3;
            this.lblScope.Text = "Ports:";
            this.lblScope.Visible = false;
            //
            this.cboScope.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
            this.cboScope.Location = new System.Drawing.Point(78, 24);
            this.cboScope.Name = "cboScope";
            this.cboScope.Size = new System.Drawing.Size(330, 23);
            this.cboScope.TabIndex = 4;
            this.cboScope.Visible = false;
            //
            // lblBaud / cboBaud
            //
            // The serial answer to "SCPI Port(s):", and the same shape of answer: a short
            // list of the values worth trying, tried in order until one replies. Editable,
            // because an instrument set to 4800 is nobody's fault but the instrument's.
            //
            this.lblBaud.AutoSize = true;
            this.lblBaud.Location = new System.Drawing.Point(424, 28);
            this.lblBaud.Name = "lblBaud";
            this.lblBaud.TabIndex = 5;
            this.lblBaud.Text = "Baud rate(s):";
            this.lblBaud.Visible = false;
            //
            this.cboBaud.FormattingEnabled = true;
            this.cboBaud.Items.AddRange(new object[] { "9600", "115200", "9600, 115200", "9600, 115200, 19200, 38400, 57600", "1200", "2400", "4800", "19200", "38400", "57600" });
            this.cboBaud.Location = new System.Drawing.Point(508, 24);
            this.cboBaud.Name = "cboBaud";
            this.cboBaud.Size = new System.Drawing.Size(130, 23);
            this.cboBaud.TabIndex = 6;
            this.cboBaud.Text = "9600, 115200, 19200, 38400, 57600";
            this.cboBaud.Visible = false;
            //
            // txtAddress
            //
            ...
            this.txtAddress.Location = new System.Drawing.Point(210, 166);
            ...
            // cboSerialPort
            //
            // The same place as the address box and never both at once — one row, one
            // address, whichever kind it is. Editable rather than a fixed list: the ports are
            // offered because nobody remembers whether the adapter came up as COM3 or COM7,
            // but a line setting still has to be typeable (COM3?baud=115200), and a port that
            // the OS has not listed can still be named.
            //
            ...
            this.cboSerialPort.Location = new System.Drawing.Point(210, 166);
            this.cboSerialPort.Name = "cboSerialPort";
            this.cboSerialPort.Size = new System.Drawing.Size(200, 23);
            this.cboSerialPort.TabIndex = 5;
            this.cboSerialPort.Visible = false;
            //
            // btnConnect
            //
        ...
        private SegmentButton rdoNetwork;
        private SegmentButton rdoSerial;
