...
.PARAMETER Version
    Version embedded in the setup file name (Desktop\bin\LabEquipmentController-v<Version>-setup.exe).
    Defaults to 1.1.0.
...
# installer\ sits next to bin\ under Desktop\, so resolve paths from here.
$desktopRoot = Split-Path -Parent $PSScriptRoot
$setup = Join-Path $desktopRoot "bin\LabEquipmentController-v$Version-setup.exe"
