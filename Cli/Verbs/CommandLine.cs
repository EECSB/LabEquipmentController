...
public static class CommandLine
{
    ...
    public const string Usage = """
        ...
        COMMANDS
          ...
          ports                    List this machine's serial ports (listed, never probed)
        ...
        ADDRESSES
          ...
          A serial port            serial://COM3       or  serial:///dev/ttyUSB0
          ... at other settings    serial://COM3?baud=115200&parity=even
          A VISA resource string   TCPIP0::192.168.1.20::inst0::INSTR  or  ASRL3::INSTR
