...
public static class SequenceExamples
{
    ...
    public static IReadOnlyList<SequenceExample> All { get; } = new[]
    {
        ...
        new SequenceExample(
            ...
            # And the scope has to be looking at the band being swept. Left wherever it
            # happened to be, every reading comes back 9.9e37 — a Rigol's way of saying it
            # could not measure that — and the run produces a column of them.
            WITH scope
                :RUN
                :CHANnel1:DISPlay ON
                :CHANnel1:COUPling AC
                :CHANnel1:SCALe 0.5
                :TIMebase:MAIN:SCALe 20e-9
                :TRIGger:SWEep AUTO
